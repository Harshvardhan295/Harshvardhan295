...
if __name__ == '__main__':
    """
    Harsh Vardhan Khajuria - GitHub profile README generator.
    Adapted from the Andrew6rant-style profile stats generator.
    Reads USER_NAME and ACCESS_TOKEN from environment variables (set as
    repo secrets) and overwrites the placeholder fields in light.svg/dark.svg.
    """
    ...
    # Note: age_data is computed but intentionally not written back into the SVG -
    # the "Role" line in light.svg/dark.svg is static text, not auto-updated.
